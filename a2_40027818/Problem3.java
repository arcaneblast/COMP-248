...
public class Problem3 {
    ...
    public static void main(String[] args) {
		...
		//Those has the count of body parts we need to draw for player1
        ...
        //Those has the count of body parts we need to draw for player2
        ...
        while (!gameEnd) {
            ...
            System.out.printf("Player 1's elephant has %s body, %s head, %s ear(s), %s trunk, %s tail, and %s leg(s).%n",
                    ...
                    player1EarLeft == 2 ? "no" : (2 - player1EarLeft) + "", 	// we add "" to cast to string
